      ...
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center py-20">
          ...
          <p className="text-gray-500">
            Build your skills, Shape your future, and unlock your potential with our
             diverse range of online courses. 
          </p>
        ...
        <footer className="my-12">
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="items-center mt-6 md:mt-0 flex flex-col">
              <h3 className="text-lg font-semibold md:mb-4">Connect with us</h3>
